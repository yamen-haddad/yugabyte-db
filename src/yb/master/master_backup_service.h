...
#define YB_MASTER_BACKUP_SERVICE_METHODS \
  ...
  (AbortSnapshotRestore)(ImportSnapshotMeta)(ExportSnapshot)(CreateSnapshotSchedule)\
  (ListSnapshotSchedules)(DeleteSnapshotSchedule)(EditSnapshotSchedule)(RestoreSnapshotSchedule)
