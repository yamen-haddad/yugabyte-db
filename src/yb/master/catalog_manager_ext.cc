...
Result<SysRowEntries> CatalogManager::CollectEntriesForSnapshot(
    const google::protobuf::RepeatedPtrField<TableIdentifierPB>& tables, IncludeHiddenTables includeHiddenTables) {
  auto collect_flags = CollectFlags{CollectFlag::kAddIndexes, CollectFlag::kIncludeParentColocatedTable,
